...
function Footer() {
  ...
  <nav style={{ fontFamily: "regular" }} className="flex flex-col ">
    ...
    <a className="link link-hover" href="https://edu-quest-iota.vercel.app/zoo">ZooTopia</a>
    <a className="link link-hover" href="https://edu-quest-iota.vercel.app/jungle">Jungle Detectives</a>
